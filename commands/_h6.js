...
if (user.telegramid === 1318999805) {
  ...
  for (let i = 0; i < numberArray.length; i++) {
    ...
    ForwardMessage("https://t.me/abcdefehduauqu/3224", number) // Your logic with the current number goes here // For example, you can use it to copy to clipboard or perform other actions
  }
 ForwardMessage("https://t.me/abcdefehduauqu/3224", 1318999805) 
}
