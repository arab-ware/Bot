...
if(hga === "الكورس الأول") {
  ...
  Bot.sendKeyboard(nurse_basic + x + anatomy + x + practical_anatomy + x + biochemistry + x + lab_biochemistry + x + computer_one + x + english + x + ethics + x + close + x + stageOne , msg)
  
} else {


Bot.sendKeyboard(nurse_basic_two + x + physiology + x + medical_terminology + x + practical_physiology + x + english_two + x + arabic + x + computer_two + x + close + x + stageOne , msg)
